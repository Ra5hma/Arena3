/*
 * This frame represents the Inn Space. 
 * Players can save and trade items,
 * Purchase ablities and skill points.
 * Players can use some ablilites.
 */
package frames;
...
public class InnFrame extends javax.swing.JFrame {
    //object with frame utility methods
    FrameManipulator frameManipulator = new FrameManipulator();
    //used for saving a game state
    SessionHandler sessionHandler = new SessionHandler();
    //used for playing sound effects
    AudioPlayer audioPlayer;
    Inn inn = new Inn(Arena.CUR_PLAYER.getLevel());
    AudioPlayer audioPlayerOne;
    AudioPlayer audioPlayerTwo;
    ...
    public InnFrame() {
        try{
            ...
            audioPlayerTwo = new AudioPlayer();
            Arena.BGM.stop();
        }
        ...
        innKeepPanel.setVisible(false);
        nightLabel.setVisible(false);
        Arena.BGM.setTrack(3);
        Arena.BGM.play();
        audioPlayerOne.setTrack(29);
        audioPlayerOne.play();
        audioPlayerTwo.setTrack(28);
        audioPlayerTwo.play();
        if(inn.getRoomCost()>Arena.CUR_PLAYER.getGold()){
    ...
    private void initComponents() {
        ...
        toInnKeep = new javax.swing.JButton();
        town = new javax.swing.JButton();
        nightLabel = new javax.swing.JLabel();
        innKeepPanel = new javax.swing.JPanel();
        jLayeredPane7 = new javax.swing.JLayeredPane();
        walk = new javax.swing.JButton();
        roomButton = new javax.swing.JButton();
        buyAbilityPotionButtonLabel = new javax.swing.JLabel();
        buyComboPotionButtonLabel = new javax.swing.JLabel();
        buyHealthPotionButtonLabel = new javax.swing.JLabel();
        buyHealthPotionButton1 = new javax.swing.JButton();
        buyAbilityPotionButton = new javax.swing.JButton();
        buyComboPotionButton = new javax.swing.JButton();
        innKeep = new javax.swing.JLabel();
        innKeepBackground = new javax.swing.JLabel();
        ...
        saveButton.setForeground(new java.awt.Color(153, 153, 0));
        saveButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/treeBark.jpg"))); // NOI18N
        saveButton.setText("SAVE");
        saveButton.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(102, 102, 0), 1, true));
        saveButton.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        saveButton.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseExited(java.awt.event.MouseEvent evt) {
                saveButtonMouseExit(evt);
            }
        });
        ...
        jLayeredPane1.add(saveButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 570, 140, 40));

        toInnKeep.setForeground(new java.awt.Color(153, 153, 0));
        toInnKeep.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/treeBark.jpg"))); // NOI18N
        toInnKeep.setText("INN KEEP");
        toInnKeep.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(102, 102, 0), 1, true));
        toInnKeep.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        toInnKeep.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                toInnKeepActionPerformed(evt);
            }
        });
        jLayeredPane1.add(toInnKeep, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 620, 140, 40));

        town.setForeground(new java.awt.Color(153, 153, 0));
        town.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/treeBark.jpg"))); // NOI18N
        town.setText("TO TOWN");
        town.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(102, 102, 0), 1, true));
        town.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        town.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                townActionPerformed(evt);
            }
        });
        jLayeredPane1.add(town, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 670, 140, 40));

        nightLabel.setBackground(new java.awt.Color(0, 0, 0));
        nightLabel.setForeground(new java.awt.Color(255, 255, 255));
        nightLabel.setAutoscrolls(true);
        nightLabel.setBorder(null);
        nightLabel.setDoubleBuffered(true);
        nightLabel.setEnabled(false);
        nightLabel.setFocusable(false);
        nightLabel.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        nightLabel.setInheritsPopupMenu(false);
        nightLabel.setOpaque(true);
        nightLabel.setRequestFocusEnabled(false);
        nightLabel.setVerifyInputWhenFocusTarget(false);
        jLayeredPane1.add(nightLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 50, 590, 420));
        nightLabel.getAccessibleContext().setAccessibleParent(jLayeredPane1);

        innKeepPanel.setOpaque(false);
        innKeepPanel.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        jLayeredPane7.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        walk.setForeground(new java.awt.Color(153, 153, 0));
        walk.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/treeBark.jpg"))); // NOI18N
        walk.setText("WALK AWAY");
        walk.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(102, 102, 0), 1, true));
        ...
        jLayeredPane7.add(walk, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 390, 140, 40));

        roomButton.setForeground(new java.awt.Color(153, 153, 0));
        roomButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/treeBark.jpg"))); // NOI18N
        roomButton.setText("ROOM: "+inn.getRoomCost()+" GOLD");
        roomButton.setToolTipText("");
        roomButton.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(102, 102, 0), 1, true));
        roomButton.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        roomButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                roomButtonActionPerformed(evt);
            }
        });
        jLayeredPane7.add(roomButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 390, 140, 40));

        buyAbilityPotionButtonLabel.setFont(new java.awt.Font("sansserif", 1, 12)); // NOI18N
        buyAbilityPotionButtonLabel.setForeground(new java.awt.Color(0, 0, 0));
        buyAbilityPotionButtonLabel.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        buyAbilityPotionButtonLabel.setText(inn.getAbilityPotionCost()+" G"
        );
        buyAbilityPotionButtonLabel.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        jLayeredPane7.add(buyAbilityPotionButtonLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(278, 240, 30, -1));

        buyComboPotionButtonLabel.setFont(new java.awt.Font("sansserif", 1, 12)); // NOI18N
        buyComboPotionButtonLabel.setForeground(new java.awt.Color(0, 0, 0));
        buyComboPotionButtonLabel.setText(inn.getComboPotionCost()+" G");
        buyComboPotionButtonLabel.setToolTipText("");
        buyComboPotionButtonLabel.setFocusable(false);
        jLayeredPane7.add(buyComboPotionButtonLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(338, 240, 30, -1));

        buyHealthPotionButtonLabel.setFont(new java.awt.Font("sansserif", 1, 12)); // NOI18N
        buyHealthPotionButtonLabel.setForeground(new java.awt.Color(0, 0, 0));
        buyHealthPotionButtonLabel.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        buyHealthPotionButtonLabel.setText(inn.getHealthPotionCost()+" G");
        buyHealthPotionButtonLabel.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        jLayeredPane7.add(buyHealthPotionButtonLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(218, 240, 30, -1));

        buyHealthPotionButton1.setBackground(new java.awt.Color(0, 0, 0));
        buyHealthPotionButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/healthPotionsm.png"))); // NOI18N
        buyHealthPotionButton1.setToolTipText("Restores "+arena3.Arena.CUR_PLAYER.getItems().get(Items.HEALTH.getName()).getHp()*100+"% of total HP"
        );
        buyHealthPotionButton1.setBorder(null);
        buyHealthPotionButton1.setContentAreaFilled(false);
        buyHealthPotionButton1.setMaximumSize(new java.awt.Dimension(82, 82));
        buyHealthPotionButton1.setMinimumSize(new java.awt.Dimension(82, 82));
        buyHealthPotionButton1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                buyHealthPotionButton1ActionPerformed(evt);
            }
        });
        jLayeredPane7.add(buyHealthPotionButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 190, 80, 80));

        buyAbilityPotionButton.setBackground(new java.awt.Color(0, 0, 0));
        buyAbilityPotionButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/abilityPotion-removebg-.png"))); // NOI18N
        buyAbilityPotionButton.setToolTipText("Restores "+arena3.Arena.CUR_PLAYER.getItems().get(Items.ABILITY.getName()).getMp()*100+"% of total MP"
        );
        buyAbilityPotionButton.setBorder(null);
        buyAbilityPotionButton.setContentAreaFilled(false);
        buyAbilityPotionButton.setMaximumSize(new java.awt.Dimension(82, 82));
        buyAbilityPotionButton.setMinimumSize(new java.awt.Dimension(82, 82));
        buyAbilityPotionButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                buyAbilityPotionButtonActionPerformed(evt);
            }
        });
        jLayeredPane7.add(buyAbilityPotionButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 190, 80, 80));

        buyComboPotionButton.setBackground(new java.awt.Color(0, 0, 0));
        buyComboPotionButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/ComboPotion.png"))); // NOI18N
        buyComboPotionButton.setToolTipText("Restores "+arena3.Arena.CUR_PLAYER.getItems().get(Items.COMBO.getName()).getHp()*100+"% of total HP and "+arena3.Arena.CUR_PLAYER.getItems().get(Items.COMBO.getName()).getMp()*100+"% of total AP"
        );
        buyComboPotionButton.setBorder(null);
        buyComboPotionButton.setContentAreaFilled(false);
        buyComboPotionButton.setMaximumSize(new java.awt.Dimension(82, 82));
        buyComboPotionButton.setMinimumSize(new java.awt.Dimension(82, 82));
        buyComboPotionButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                buyComboPotionButtonActionPerformed(evt);
            }
        });
        jLayeredPane7.add(buyComboPotionButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 190, 80, 80));

        innKeep.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/InnKeep.png"))); // NOI18N
        jLayeredPane7.add(innKeep, new org.netbeans.lib.awtextra.AbsoluteConstraints(-30, 70, 270, 370));

        innKeepBackground.setBackground(new java.awt.Color(34, 16, 12));
        innKeepBackground.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/bar.jpg"))); // NOI18N
        innKeepBackground.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(255, 255, 204), 10, true));
        innKeepBackground.setOpaque(true);
        jLayeredPane7.add(innKeepBackground, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 10, -1, 440));

        innKeepPanel.add(jLayeredPane7, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, 620, 460));

        jLayeredPane1.add(innKeepPanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 20, 630, 480));
        ...
        heroIntLabel.setRequestFocusEnabled(false);
        ...
        BackGround.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/SizedInn.PNG"))); // NOI18N
    ...
    private void goToInnkeeperActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_goToInnkeeperActionPerformed
        
    }//GEN-LAST:event_goToInnkeeperActionPerformed

    /**
     * Takes player to the travel frame when the town button is clicked
     * @param evt clicking the town button
     */
    ...
    /**
     * Return to the main Inn frame from the innkeeper sub-frame when selecting walk
     * @param evt clicking the walk button
     */
    ...
    /**
     * Save game state when clicking the save button
     * @param evt 
     */
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        ...
        audioPlayer.playOnce();
        sessionHandler.save();
        saveButton.setText("FILE SAVED!");
    }//GEN-LAST:event_saveButtonActionPerformed
    
    /**
     * Open inn keep menu when clicking on the to inn keep button
     * @param evt clicking the to inn keep button 
     */
    private void toInnKeepActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_toInnKeepActionPerformed

        audioPlayer.setTrack(2);
        audioPlayer.playOnce();
        innKeepPanel.setVisible(true);
    }//GEN-LAST:event_toInnKeepActionPerformed
    ...
    private void roomButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_roomButtonActionPerformed
        ...
        if(inn.canAfford(inn.getRoomCost())){
            this.roomRental();
            inn.rentRoom();
            try {
                Arena.BGM.stop();
            ...
            audioPlayer.playOnce(27);
            updateForm();
        }
        else{
            audioPlayer.playOnce(26);
        }
     ...
     * @param evt - on button click
     */
    private void buyHealthPotionButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buyHealthPotionButton1ActionPerformed
        
        if(inn.buyHealthPotion()){
            audioPlayer.playOnce(25);
            updateForm();
        }
        else{
            audioPlayer.playOnce(26);
        }
    }//GEN-LAST:event_buyHealthPotionButton1ActionPerformed

    /**
     * Buys ability potion
     * @param evt - on button click
     */
    private void buyAbilityPotionButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buyAbilityPotionButtonActionPerformed
            
        if(inn.buyAbilityPotion()){
            audioPlayer.playOnce(25);
            updateForm();
        }
        else{
    ...
    }//GEN-LAST:event_buyAbilityPotionButtonActionPerformed
     ...
     * @param evt - on button click
     */
    private void buyComboPotionButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buyComboPotionButtonActionPerformed
        
        if(inn.buyComboPotion()){
            audioPlayer.playOnce(25);
            updateForm();
        }
        else{
    ...
    }//GEN-LAST:event_buyComboPotionButtonActionPerformed

    private void saveButtonMouseExit(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_saveButtonMouseExit
        saveButton.setText("SAVE");
    }//GEN-LAST:event_saveButtonMouseExit
    ...
    private javax.swing.JButton buyAbilityPotionButton;
    private javax.swing.JLabel buyAbilityPotionButtonLabel;
    private javax.swing.JButton buyComboPotionButton;
    private javax.swing.JLabel buyComboPotionButtonLabel;
    private javax.swing.JButton buyHealthPotionButton1;
    private javax.swing.JLabel buyHealthPotionButtonLabel;
    ...
    private javax.swing.JLabel innKeep;
    private javax.swing.JLabel innKeepBackground;
    private javax.swing.JPanel innKeepPanel;
    ...
    private javax.swing.JButton toInnKeep;
    ...
    */  
    ...
    /**
     * Rents a room, plays darken animation, restores HP and MP
     */
    public void roomRental() {
        ...
        SwingWorker<Void, Void> worker = new SwingWorker<Void, Void>(){ 
            ...
            protected Void doInBackground() throws Exception {
            for(int i = 1; i<50; i++){
                nightLabel.setBackground(new Color(0,0,0, i));
